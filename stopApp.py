...
def webFramesUnique():
    ...
    if len(busList[0]) >= 3:
        ...
        time2 = "N/A"
        time3 = "N/A"
    return render_template('index.html', location1=location1, bus1=bus1, bus2=bus2, time1=time1, time2=time2, bus3=bus3, time3=time3)
...
def webFramesUnique2():
    ...
    if len(busList2[0]) >= 3:
        ...
        time2x2 = "N/A"
        time2x3 = "N/A"
    return render_template('index2.html', bus1=bus2x1, bus2=bus2x2, time1=time2x1, time2=time2x2, bus3=bus2x3, time3=time2x3, location2=location2)
